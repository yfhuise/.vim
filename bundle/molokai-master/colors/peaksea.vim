...
if &background=='light' 
  ...
  " For reversed stuffs, clear the reversed prop and set the NONE prop again
...
elseif &background=='dark' 
  ...
  if &t_Co==8 || &t_Co==16
    ...
    if &t_Co==8
      ...
      " setting the 'NONE' attribute, will get bright foreground colour.
      ...
      " Well, well, NONE font with color 0-7 is not possible.
